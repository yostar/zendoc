...
When discussing or modifying Zendoc, understand that:
- **This is the prototype.** Changes here are changes to the product itself.
- **The "product" is the configuration.** Zendoc is not a separate app; it is this environment—tuned for writing, with auto-save, auto-publish to GitHub, and a minimal UI.
- **Reference `projects/zendoc/`** for vision, roadmap, business model, and technical spec.
