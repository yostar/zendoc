            ...
            try {
                ...
                for (const extId of REQUIRED_EXTENSIONS) {
                    try {
                        ...
                        vscode.window.showWarningMessage(`Could not install ${extId}. Install it manually from the Extensions panel when the workspace opens.`, 'Show Extensions').then((choice) => {
